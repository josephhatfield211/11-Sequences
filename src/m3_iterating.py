...
def run_test_count_negatives():
    ...
    # Test 6:
    expected = 4
    actual = count_negatives([-442, -420, -69, -23981084098309810983348279450923840975308273472039875082735872093479234987430580237402735080273947808475029384097])
    print()
    ...
    # Test 7:
    expected = 1
    actual = count_negatives((5, 4, 1221, -10))
    print()
...
def run_test_count_short_ones():
    ...
    # Test 8:
    expected = 2
    seq = [[8675309,3248923405,234927834923409283049],[7355608],[123,239823498234],[12,2,34,234,23,42,34,2],[1,23,12,12,3,123,123,1,23,123,123,1]]
    actual = count_short_ones(seq)
    print()
    ...
    # Test 9:
    expected = 3
    seq = [[1],[111],[55555],[5342.45,456,456,4,6,5,55,6,4,56,5,5,56,456,456,456456],[5,324,23,4,234,2]]
    actual = count_short_ones(seq)
    print()
